...
import { INITIAL_HERO, LEGACY_AVATAR_IDS, legacyAvatarRefund, normalizeHero } from '../src/game/heroParts'
 ...
 * + procedural accessory/visor/aura system was pruned (v9). These cover the
 * migration path a legacy save takes: any older blob is coerced to the reduced
 * canonical shape, retired avatars are refunded, and nothing dangles.
 */
