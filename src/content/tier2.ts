...
export const tier2: Challenge[] = [
  {
    ...
    tier: 2,
    title: 'New Window',
    brief: 'Panes not enough? Open a whole new window (like a new tab) with `Ctrl-b` then `c`.',
    ...
    par: 2,
    hint: '`Ctrl-b` then `c` creates a fresh window and jumps you to it. The status bar at the bottom lists your windows.',
  },
  {
    id: 't2-rename',
    tier: 2,
    title: 'Name It',
    brief: "This window is called 'zsh'. Rename it to `editor` so you can find it: `Ctrl-b`, then `,` then type the name and `Enter`.",
    ...
    par: 9,
    hint: '`Ctrl-b` then `,` opens a rename prompt. Type `editor` and press `Enter`.',
  },
  {
    id: 't2-switch',
    tier: 2,
    title: 'Window Hop',
    brief: "You're on window 0 (editor). Move to the next window with `Ctrl-b` then `n`.",
  ...
  },
  {
    ...
    brief: 'Windows are numbered from 0 in the status bar. Jump straight to window 2 with `Ctrl-b` then `2`.',
    ...
    par: 2,
    hint: '`Ctrl-b` then a digit jumps directly to that window number. Note the first window is 0, not 1.',
  },
  {
    id: 't2-kill-window',
    tier: 2,
    title: 'Close a Window',
    brief: 'The middle window is done with. Close the current window with `Ctrl-b` then `&`.',
    ...
    par: 2,
    hint: '`Ctrl-b` then `&` closes the whole window and every pane in it. (Real tmux confirms first.)',
  },
  {
    id: 't2-capstone',
    tier: 2,
    ...
    par: 9,
    hint: '`Ctrl-b` `c` makes the window (and focuses it), then `Ctrl-b` `,` to rename it to `logs` and `Enter`.',
  },
]
