...
function blob(color: string, s: CSSProperties): CSSProperties {
  return {
    ...
    animation: 'tx-aurora-drift 20s ease-in-out infinite',
    ...s,
  }
}
        ...
        <div className="absolute inset-x-0 bottom-0 h-[36%] [perspective:320px]">
          <div
            ...
            style={{
              ...
              opacity: 0.16,
              animation: 'tx-grid-scroll 2.6s linear infinite',
            }}
          />
        </div>
      </ParallaxLayer>
        ...
        <div className="absolute inset-x-0 bottom-0 h-[42%] [perspective:300px]">
          <div
            ...
            style={{
              ...
              opacity: 0.45,
              animation: 'tx-grid-scroll 1.5s linear infinite',
            }}
          />
        </div>
      </ParallaxLayer>
...
function NebulaBg() {
  return (
    <ParallaxScene className="absolute inset-0" style={{ background: 'radial-gradient(ellipse at 28% 18%, #1e1b4b 0%, #0a0e14 68%)' }}>
      ...
      <ParallaxLayer depth={0.95} style={{ ...starLayer('#ffffff', 0.9, 150), animation: 'tx-flicker 4s ease-in-out infinite' }} />
    </ParallaxScene>
  )
}
